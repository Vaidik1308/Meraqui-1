...
const Warehousing = () => {
  return (
    <main className='sm:w-[100%] sm:mx-auto'>
        ...
        <div style={{backgroundImage:"url(https://images.unsplash.com/photo-1553413077-190dd305871c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80)"}} className='bg-cover bg-center w-full sm:h-[105vh]'>
        <div className='  flex flex-col w-full bg-black bg-opacity-[0.7] text-white sm:h-[105vh] sm:justify-center'>
