...
const Footer = () => {
  return (
    <footer className=' bg-cyan-100 w-[100%] h-[100vh] flex flex-col  sm:pt-4 sm:h-[90vh] font-poppins '>
         <div className='flex flex-col sm:flex-row sm:w-[80%]  sm:mx-auto sm:justify-center sm:mb-8 sm:pb-8'> 
            <div className='w-full sm:flex sm:flex-row sm:justify-around sm:w-[53%]'>
                <div className=' flex flex-col w-full sm:w-[100%] sm:justify-between sm:h-[35vh] sm:text-left'>
                    ...
                    <div className='flex flex-row justify-center w-full mt-4 sm:w-[66%] sm:mt-12'>
                    ...
                    <div className='flex flex-row justify-center w-full sm:w-[100%] sm:mt-4 mt-4'>
                        ...
                        <a className='font-poppins  sm:w-[85%] sm:h-[5vh] sm:flex sm:flex-col sm:justify-center sm:text-left' href="meraqui.ventures@gmail.com">contact@meraqui.com</a>
                    </div>
                </div>
            </div>
            <div className='flex flex-row mt-8 justify-evenly   sm:w-[85%] sm:mt-12'>
                <div className='w-[30%] '>
                    <div className='w-[100%] text-[0.85rem] sm:w-[60%] sm:flex sm:flex-col sm:justify-center' >
                        <h3 className='w-fit ml-4  border-b-[3px] border-cyan-500 sm:text-[1.3rem] font-poppins '>Quick Links</h3>
                        <ul className=" mt-[20px] flex flex-col justify-evenly h-40 font-poppins  sm:text-left sm:ml-4">
                ...
                <div className='w-[30%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem] ' >
                        <h3 className='w-fit ml-4  border-b-[3px] border-cyan-500 sm:text-[1.3rem] font-poppins '>Services</h3>
                        <ul className= "font-poppins  mt-[38px]  flex flex-col justify-start h-40   sm:text-left sm:ml-4 sm:mt-[38px] ">
                ...
                <div className='w-[33%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem]' >
                        <h3 className='w-fit ml-4  border-b-[3px] border-cyan-500 sm:text-[1.3rem] font-poppins '>Services</h3>
                        <ul className="mt-8 flex flex-col justify-center  font-poppins  sm:text-left sm:ml-4 sm:h-[24vh] sm:mt-[28px]">
        ...
        <div className='w-full sm:mt-16 mt-16'>
            <h2 className='text-2xl font-poppins  sm:mb-14 '>Follow our socials</h2>
        </div>
        <div className=' flex flex-row w-full justify-evenly mt-2  sm:w-[60%] sm:mx-auto'>
         ...
         <div className=  'flex flex-row w-full justify-evenly mt-8 font-semibold sm:w-[60%] sm:mx-auto  font-poppins' >©Copyright 2022@MERAQUI</div>
