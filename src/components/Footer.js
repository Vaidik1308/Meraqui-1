...
const Footer = () => {
  return (
    <footer className=' bg-cyan-100 w-[100%] h-fill pb-8 sm:pb-16 flex flex-col  sm:pt-8 sm:h-[100vh] font-poppins '>
         <div className='flex flex-col sm:flex-row sm:w-[80%]  sm:mx-auto sm:justify-center sm:mb-8 sm:pb-8'> 
            <div className='w-full sm:flex sm:flex-row sm:justify-around sm:w-[53%]'>
                <div className=' flex flex-col w-full sm:w-[100%] sm:justify-between sm:h-[45vh] sm:text-left'>
                    ...
                    <div className='flex flex-row justify-center w-full mt-4 sm:w-[66%] sm:mt-12 px-4'>
                    <span className='sm:w-[15%] text-[2rem] text-cyan-400 mr-2 sm:text-[2.8rem] sm:h-fill'><BiConversation/></span>
                        {/* <p className='sm:left-0 flex justify-center sm:justify-start sm:ml-16 font-poppins font-[400] relative left-[-15%]'> */}
            ...
            <div className='flex flex-row mt-8 justify-evenly   sm:w-[85%] sm:mt-12'>
                <div className='w-[30%] '>
                    <div className='w-[100%] text-[0.85rem] sm:w-[60%] sm:flex sm:flex-col sm:justify-center' >
                        ...
                        <ul className=" mt-[20px] flex flex-col justify-evenly h-40 font-poppins font-[300]  sm:text-left sm:ml-4">
                ...
                <div className='w-[30%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem] ' >
                        <h3 className='w-fit ml-4  border-b-[3px] border-cyan-500 sm:text-[1.3rem] font-poppins font-[400]'>Services</h3>
                        <ul className= "font-poppins font-[300]  mt-[36px]  flex flex-col justify-start h-40   sm:text-left sm:ml-4 sm:mt-[38px] ">
                ...
                <div className='w-[33%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem]' >
                        <h3 className='w-fit ml-4  border-b-[3px] border-cyan-500 sm:text-[1.3rem] font-poppins font-[400]'>Services</h3>
                        <ul className="mt-[35px] flex flex-col justify-center  font-poppins font-[300]  sm:text-left sm:ml-4 sm:h-[24vh] sm:mt-[8px]">
        ...
        <div className=' flex flex-row w-full justify-evenly mt-2  sm:w-[60%] sm:mx-auto'>
         ...
         <div className=  'flex flex-row w-full justify-evenly mt-12  sm:w-[60%] sm:mx-auto  font-poppins font-[300]' >©Copyright 2022@MERAQUI</div>
