...
const Footer = () => {
  return (
    <footer className=' bg-cyan-100 w-[100%] h-fill pb-8 sm:pb-16 flex flex-col  sm:pt-4 sm:h-[95vh] font-poppins '>
            ...
            <div className='w-full sm:flex sm:flex-row sm:justify-around sm:w-[53%]'>
                <div className=' flex flex-col w-full sm:w-[100%] sm:justify-between sm:h-[35vh] sm:text-left'>
                    <div className='w-[100%] flex justify-center mt-2 sm:w-[50%] '>
                        <img className=' w-[100%] flex justify-center sm:w-[90%]' src={require('../image/logo.png')} alt="" />
                    </div>
                    ...
                    <div className='text-left w-[93%]'>
                        <p className='sm:left-0 flex justify-center sm:justify-start sm:ml-16 font-poppins font-[400] relative left-[-15%]'>+91-9560772719</p>
                    </div>
        ...
        <div className='w-full sm:mt-16 mt-16'>
            <h2 className='text-2xl font-poppins font-[300]  sm:mb-14 '>Follow our socials</h2>
        </div>
        <div className=' flex flex-row w-full justify-evenly mt-2  sm:w-[60%] sm:mx-auto'>
         ...
         <div className=  'flex flex-row w-full justify-evenly mt-8  sm:w-[60%] sm:mx-auto  font-poppins font-[300]' >©Copyright 2022@MERAQUI</div>
