  ...
  return (
    <footer className=' bg-cyan-100 w-[100%] h-[110vh] flex flex-col font-extrabold sm:pt-8 sm:h-[100vh]'>
        ...
        <div className=' flex flex-row w-full justify-evenly mt-2  sm:w-[60%] sm:mx-auto'>
            <div className="">
                <a href='#main'> <BsInstagram className='text-[4rem] w-[60%] text-cyan-400'/></a>
            </div>
            <div className="">
                <a href='#main'><BsFacebook className='text-[4rem] w-[60%] text-cyan-400'/></a>
            </div>
            <div className="">
                <a href='#main'><FaLinkedin className='text-[4rem] w-[60%] text-cyan-400' /></a>
            </div>
            <div className="">
                <a href='#main'><BsTwitter className='text-[4rem] w-[60%] text-cyan-400'/></a>
            </div>
        </div>
    </footer>
  )
