  ...
  return (
    <footer className=' bg-cyan-100 w-[100%] h-[110vh] flex flex-col font-extrabold sm:pt-8 sm:h-[100vh]'>
            ...
            <div className='w-full sm:flex sm:flex-row sm:justify-around sm:w-[53%]'>
                <div className=' flex flex-col w-full sm:w-[100%] sm:justify-between sm:h-[35vh] sm:text-left'>
                    ...
                    <div className='text-left w-[93%]'>
                        <p className=' flex justify-center sm:justify-start sm:ml-16'>+91-9560772719</p>
                    </div>
            ...
            <div className='flex flex-row mt-8 justify-evenly  font-normal sm:w-[85%] sm:mt-12'>
                <div className='w-[30%] '>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center' >
                        ...
                        <ul className=" mt-2 flex flex-col justify-evenly h-40 font-poppins sm:text-left sm:ml-4">
                ...
                <div className='w-[30%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center' >
                        ...
                        <ul className="mt-[38px]  flex flex-col justify-start h-40 font-poppins text-[0.85rem] sm:text-left sm:ml-4 sm:mt-[38px] ">
                ...
                <div className='w-[30%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center' >
                        <h3 className='w-fit ml-4  border-b-[3px] border-cyan-500 sm:text-[1.3rem]'>Services</h3>
                        <ul className="mt-4 flex flex-col justify-center sm: h-40 font-poppins sm:text-left sm:ml-4 sm:h-[24vh] sm:mt-[28px]">
        ...
        <div className=' flex flex-row w-full justify-evenly mt-2  sm:w-[60%] sm:mx-auto'>
            ...
            <div className="">
                <a href='' target='blank'><BsTwitter className='text-[4rem] w-[60%] text-cyan-400'/></a>
            </div>
        </div>
    </footer>
  )
