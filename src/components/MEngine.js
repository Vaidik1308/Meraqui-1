...
const MEngine = () => {
  ...
  return (
    <main className='w-full h-fill mb-4 sm:w-[85%] sm:mx-auto sm:mt-8'>
        <section className='mt-4 pt-4 sm:mt-20 w-[95%] mx-auto flex sm:flex-row sm:justify-between flex-col'>
            <div className=' w-full sm:w-[40%] flex flex-col sm:h-[55vh] sm:justify-center'>
                <div className='w-full '>
                    <h2 className=' text-left text-3xl sm:text-5xl font-normal w-full sm:text-left sm:ml-2'>
                        KARAM-AI
                    </h2>
                </div>
                <div className=' mt-2 text-left sm:mt-12'>
                    <p className='text-black font-normal sm:text-[1.2rem]  sm:leading-[1.8]'>
        ...
        <section className='flex flex-col w-full mt-8 sm:mt-0'>
            <div className='w-full ml-4 '>
                <h1 className='text-4xl font-normal w-full text-left sm:w-[100%] sm:text-center sm:text-4xl'>About Karam-AI</h1>
            </div>
            <div className='w-full  mt-4 sm:mt-12'>
                <p className='font-normal  text-left w-[95%] mx-auto sm:text-[1.2rem]'>
        ...
        <section className='flex flex-col w-full mt-14 font-normal sm:w-[95%] sm:mx-auto'>
            <div className='w-full'>
                <h2 className='text-[1.8rem] sm:text-4xl px-1 font-normal'>Why you'll love M-Engine</h2>
            </div>
            ...
            <div className='sm:hidden h-[2vh] flex flex-row my-12 w-[90%] mx-auto'>
                ...
                <div className='w-full sm:w-[100%] sm:mt-16 flex flex-col sm:h-[65vh] mt-4 sm:justify-between'>
                    <div className='w-full text-left text-2xl ml-4  sm:mb-8 sm:text-4xl'>
                        <h3 className='font-normal'>{content[originalIndex].header1} <span className='text-cyan-300 duration-500'>{content[originalIndex].header2}</span></h3>
                    </div>
                ...
                <div className=' rounded-sm sm:w-[100%] w-[80%]   h-[60vh] mx-auto sm:relative sm:right-[-10%] sm:mt-8 '>
                    ...
                    {/* <img className='w-[100%] transition' src={content[originalIndex].img} alt="" /> */}
                </div>
