        ...
        <section className='flex flex-col w-full mt-8 sm:mt-0 font-poppins font-[300]'>
            ...
            <div className='w-full  mt-4 sm:mt-12'>
                <p className='  text-left w-[95%] mx-auto sm:text-[1.2rem]'>
                    With user-friendly On-boarding engine, Karam helps them with seamless self- onboarding. Karam’s role doesn’t end with hiring a candidate. He works tirelessly to record their daily attendance with a single motto: Candidates’ salary must get credited on time along with compliance. Every month. Flawlessly. <br />
                    Karam comes handy in their times of dire need of money. He extends them salary advance, loans apart from their rightful cover under statutory dues and/or other insurance packages. <br />
                    Karam tracks a candidate’s life cycle from hire to retire and becomes organisations go-to person to solve daily HR needs.
                </p>
            </div>
        </section>
