  ...
  return (
    <main className='w-[95%] sm:w-[100%] mx-auto sm:mx-auto h-fill my-12 sm:mt-32' id='#services'>
      ...
      <div className='w-full sm:flex sm:flex-row-reverse sm:justify-center sm:w-[90%] sm:mx-auto'>
          ...
          <div className='mt-4 sm:w-[55%] sm:relative sm:left-[-10%]'>
            <img className='rounded sm:w-full' src="https://images.unsplash.com/photo-1590496794008-383c8070b257?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1091&q=80" alt="" />
          </div>
        </div>
      </section>
      ...
      <div className='sm:flex sm:flex-row sm:w-[93%] sm:mx-auto'>
            ...
            <div className='mt-4 sm:w-[60%] sm:relative sm:right-[-10%]'>
              <img className='rounded sm:w-[100%] ' src="https://plus.unsplash.com/premium_photo-1661476110320-b186794b7844?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1161&q=80" alt="" />
            </div>
          </div>
      </section>
