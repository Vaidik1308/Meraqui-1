...
const MainPart2 = () => {
  ...
  const slides = [
    ...
    {url: "https://images.unsplash.com/photo-1601924994987-69e26d50dc26?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",title:"Manufacture"},
  ...
  const postInfo = [
      ...
      content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio matti..ro et velibero et velit interdum, ac aliquet odio matti...",
      date:"02/06/23",
      ...
      caption:"Post caption2",
      content:"Lorem ipsum dolor e libero et velit interdum, ac aliquet odio matti...Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio matti...",
      date:"02/06/23",
      publication:"publication"
    },
      ...
      caption:"Post caption3",
      content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio matt libero eutateulputate libero et velit interdum, ac aliquet odio matti...",
      date:"02/06/23",
      publication:"publication"
    },
      ...
      caption:"Post caption4",
      content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio matti...Lorequet, et velit interdum, ac aliquet odio matti...",
      date:"02/06/23",
      publication:"publication"
    }
  ]
  const newsInfo = [
      {url:'https://images.unsplash.com/photo-1587614313085-5da51cebd8ac?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
      caption:"Post caption1",
      content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velc vulputate libero et velit interdum, ac aliquet odio matti...",
      date:"02/06/23",
      publication:"publication"
    },
      {url:'https://images.unsplash.com/photo-1495020689067-958852a7765e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80',
      caption:"Post caption2",
      content:"Lorem ipsum dolor sit amet, consectetur acing elit. Nunc vulputate libero et velit interdum, ac aliquet odio matti...",
      date:"02/06/23",
      publication:"publication"
    },
      {url:'https://images.unsplash.com/photo-1546422904-90eab23c3d7e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1172&q=80',
      caption:"Post caption3",
      content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit inadipiscing elit. Nunc vulputate libero et velit",
      publication:"publication"
    },
      {url:'https://images.unsplash.com/photo-1503694978374-8a2fa686963a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80',
      caption:"Post caption4",
      content:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum", 
      publication:"publication"
    }
  ]
    ...
    <main className='w-full mt-10 sm:mt-24 font-bold sm:w-[85%] sm:mx-auto sm:font-normal sm:h-full'>
      <section className='hidden sm:block'>
        <div className='flex flex-col'>
              <div className='w-full'>
                <h3 className='w-full text-3xl font-normal sm:text-[2.9rem]'>We have worked across all industries</h3>
              </div>
              <div className='w-full flex justify-center mt-2 sm:m-6'> 
                <p className=' text-[1rem] font-normal sm:text-[1.3rem] w-[75%]'>We are bridging the gap between employees and businesses since 2019!</p>
              </div>
        </div>
        <Swiper 
        className='sm:w-[100%] sm:h-[70vh]'
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[0].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[0].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[1].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[1].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[2].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[2].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
      ...
      <section className='hidden sm:block mt-16'>
        <div className='w-full flex flex-col sm:h-[16vh] h-[25vh]'>
            <div className='w-full'>
              <h3 className='w-full text-3xl font-normal sm:text-5xl'>Find us on our socials</h3>
            </div>
            <div className='w-full flex justify-center mt-2 sm:m-6'> 
              <p className='text-[1rem] font-normal sm:text-[1.3rem] w-[75%]'>We are bridging the gap between employees and businesses since 2019!</p>
            </div>
          ...
          <SwiperSlide className='rounded-[12px]'>
              <div className='rounded-[12px] mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    <div className='text-left text-[1.3rem] font-normal sm:w-[100%]'>
                      <h3>{postInfo[0].caption}</h3>
                    </div>
                    <div className='text-left text-[0.8rem] mt-4  '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500 leading-[1.6]'>{postInfo[0].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
                  </div>
              </div>
          </SwiperSlide>
          <SwiperSlide>
              <div className='rounded-[12px] mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4  '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500 leading-[1.6]'>{postInfo[1].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
          ...
          <SwiperSlide>
              <div className='rounded-[12px]  mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4 '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500 leading-[1.6]'>{postInfo[2].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
          ...
          <SwiperSlide>
              <div className='rounded-[12px]  mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4 '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500 leading-[1.6]'>{postInfo[3].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
      ...
      <section className='hidden sm:block mt-4 sm:h-[90vh]'>
        <div className='w-full flex flex-col sm:h-[16vh] h-[25vh]'>
            <div className='w-full'>
              <h3 className='w-full text-3xl font-normal sm:text-5xl'>Meraqui in news</h3>
            </div>
            <div className='w-full flex justify-center mt-2 sm:m-6'> 
              <p className='text-[1rem] font-normal sm:text-[1.3rem] w-[75%]'>We are bridging the gap between employees and businesses since 2019!</p>
            </div>
        ...
        >
          <SwiperSlide className='rounded-[12px]'>
              <div className='rounded-[12px] mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  <div style={{backgroundImage:`url(${newsInfo[0].url})`}} className='rounded-[12px]  bg-cover  w-[100%] h-[25vh]  sm:w-[100%] sm:h-[90vh] '>
                  </div>
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    <div className='text-left text-[1.3rem] font-normal sm:w-[100%]'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4  '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500'>{newsInfo[0].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
          ...
          <SwiperSlide>
              <div className='rounded-[12px] mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4  '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500'>{newsInfo[1].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
          ...
          <SwiperSlide>
              <div className='rounded-[12px]  mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4 '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500'>{newsInfo[2].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
          ...
          <SwiperSlide>
              <div className='rounded-[12px]  mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[100%] sm:flex sm:flex-col  bg-cyan-100 sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4 '>
                      <p className=' sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify duration-500'>{newsInfo[3].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                      <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' />
                    </div>
      ...
      <section className=' sm:hidden w-full flex flex-col sm:mb-4 sm:h-full'>
        ...
        <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
            <div style={{backgroundImage:`url(${slides[currentIndex].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
              <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[currentIndex].title}</h3>
              </div>
            </div>
            {/* left arrow */}
      ...
      <div className='w-full flex flex-col sm:h-[16vh] h-[25vh]'>
        ...
        <div className=' mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[90%] sm:flex sm:flex-row  bg-cyan-100 sm:h-[60vh]'>
            ...
            <div className='w-full flex flex-col justify-evenly h-full mt-8 sm:w-[50%] sm:justify-evenly sm:mx-auto sm:h-full px-2'>
              <div className='text-left text-[1.8rem] font-normal'>
                <h3>{postInfo[postIndex].caption}</h3>
              </div>
              <div className='text-left text-[1rem] mt-4 sm:font-semibold '>
                <p className=' sm:h-[30vh] h-[25vh] overflow-y-auto overflow-x-hidden text-justify duration-500'>{postInfo[postIndex].content}</p>
              </div>
              <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
      ...
      <div className='w-full flex flex-col '>
        ...
        <div className=' mt-10  h-[80vh] mx-auto    relative group shadow-md w-[90%] sm:flex sm:flex-row  bg-cyan-100 sm:h-[55vh]'>
            ...
            <div className='w-full flex flex-col justify-evenly h-[55vh] mt-8 sm:w-[50%] sm:justify-evenly sm:mx-auto sm:h-full px-2'>
              ...
              <div className='text-left text-[1rem] mt-4 sm:font-semibold'>
                <p className='sm:h-[30vh] sm:overflow-y-auto sm:overflow-x-hidden text-justify'>{newsInfo[newsIndex].content}</p>
              </div>
              <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:text-right sm:mb-8'>
