...
const MainPart2 = () => {
  ...
  //   const newIndex = isFirstSlide ? slides.length - 1 : slidesIndex - 1;
  //   setSlidesIndex(newIndex)
  // }
  // const nextSlides = () => {
  //   const isLastSlide = slidesIndex === slides.length - 1;
  //   const newIndex = isLastSlide ? 0 : slidesIndex + 1;
  // setSlidesIndex(newIndex) 
  // }
    ...
    <main className='w-full mt-10 sm:mt-24 font-bold sm:w-[85%] sm:mx-auto sm:font-normal sm:h-full'>
      ...
      >
        ...
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[3].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[3].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[4].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[4].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[5].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[5].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[6].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[6].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[7].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[7].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[8].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[8].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide>
        {/* <SwiperSlide>
          ...
          <div className=' mt-10  h-[30vh] w-full m-auto px-4 relative group sm:h-[60vh] sm:font-normal'>
              <div style={{backgroundImage:`url(${slides[9].url})`}} className=' rounded bg-center bg-cover bg-no-repeat w-[100%] h-[25vh] sm:h-full duration-500'>
                <div className= ' relative flex justify-center self-center rounded text-white w-full h-[25vh] sm:h-[60vh] bg-opacity-[0.6] bg-black'>
                  <h3 className='text-center absolute top-[45%] text-3xl font-normal sm:text-5xl  ' >{slides[9].title}</h3>
                </div>
              </div>
          </div>    
        </SwiperSlide> */}
