        ...
        <section className='w-full flex flex-col mb-10 sm:flex-row sm:justify-center sm:w-[95%] sm:mx-auto'>
            <div className='w-[100%] flex flex-col justify-evenly h-[45vh] sm:w-[35%]'>
                <div className='w-full sm:ml-2'>   
                    <h1 className='sm:text-5xl sm:text-left text-3xl'>Let's Get in touch</h1>
                </div>
                <div className=' mt-2 w-full flex justify-center'>
                    <p className='text-[1rem] w-[95%] sm:leading-[2] sm:text-left'>
                ...
                <div className='w-full sm:flex sm:justify-start sm:ml-2 sm:w-[80%]'>
                    <button className=' font-sans h-[5vh] bg-cyan-100 border-[1px] border-cyan-400 w-[40%] sm:text-[0.8rem] sm:font-bold'>Contact Us</button>
                </div>
            </div>
        ...
        <section className='bg-cyan-100 w-full h-fill pt-10 sm:flex sm:flex-row sm:h-[40vh]'>
                ...
                <div className=' flex flex-row w-[90%]'>
                    ...
                    <div className='ml-2 w-[60%] sm:ml-8'>
                        <div className='w-full'>
                            <h2 className=' font-sans text-xl font-medium  text-left sm:text-[1rem]'>ADDRESS:</h2>
                        </div>
            ...
            <div className=' w-full sm:w-[40%] flex justify-center '>
                <div className=' flex flex-row w-[90%]'>
                    ...
                    <div className='ml-2 w-[60%] sm:ml-8'>
                        <div className='w-full'>
                            <h2 className=' font-sans text-xl font-medium  text-left sm:text-[1rem]'>PHONE:</h2>
                        </div>
                        <div className='w-full mt-2 flex'>
                            <p className='text-left'>
                            +91-9560772719
            ...
            <div className=' w-full sm:w-[40%] flex justify-center '>
                <div className=' flex flex-row w-[90%]'>
                    ...
                    <div className='ml-2 w-[60%] sm:ml-8'>
                        <div className='w-full'>
                            <h2 className=' font-sans text-xl font-medium  text-left sm:text-[1rem]'>WORK HOURS:</h2>
                        </div>
                        <div className='w-full mt-2 flex'>
                            <p className='text-left'>
                                Monday - Saturday <br />
