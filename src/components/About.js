    ...
    <main className='w-full sm:mt-24 ' id='about'>
      ...
      <section className='w-full my-12 '>
        <div className='w-full mb-4 sm:mb-16'>
          <h2 className='text-3xl sm:text-4xl font-poppins font-[300]'>Why MERAQUI?</h2>
        </div>
      ...
      <section className='w-[95%] mx-auto my-12'>
        ...
        <div className='w-full sm:flex sm:flex-row sm:ml-16 sm:justify-center'>
          <div className='w-full mt-6 sm:w-[60%] sm:flex sm:flex-col sm:justify-between sm:h-[25vh] sm:my-auto'>
            <div className='w-full'>
              <h3 className='text-[1.4rem] sm:text-[1.6rem] text-left font-poppins font-[300]'>The Team</h3>
            </div>
            <div className='w-full mt-1 sm:mt-8 sm:w-[70%]'>
              <p className='text-left sm:w-full font-poppins font-[300]'>
        ...
        <section className='bg-[#F5F5F5] p-8 h-fill w-[100%] font-poppins font-[300]'>
        <div className=' grid  grid-cols-1 sm:grid-cols-3 sm:w-[95%] sm:ml-32 sm:mx-auto'>
          <div className='sm:flex sm:flex-col w-[100%] mb-4 sm:mb-0'>
            <div className='rounded-[10px] flex justify-center bg-white sm:w-[68%] sm:rounded-[10px] sm:h-[30vh] sm:flex sm:justify-center'>
          ...
          <div className='sm:flex sm:flex-col w-[100%] mb-4 sm:mb-0'>
            ...
            <div className='sm:flex w-[100%]  sm:w-[68%] sm:bottom-5 sm:relative sm:mb-8'>
              <div className=' flex justify-center w-[88%] mx-auto rounded-[10px] bottom-6 relative shadow-lg h-[10vh] flex-col sm:mx-auto bg-white sm:shadow-sm sm:w-[88%] sm:h-[15vh] sm:flex sm:justify-center sm:flex-col sm:rounded-[10px] sm:relative '>
                <h2 className='font-poppins font-[400]' className='  ' >Sachin Chavan</h2>
