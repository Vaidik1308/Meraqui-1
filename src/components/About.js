...
const About = () => {
  ...
  const clientsInfo = [
      ...
      body:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio matti...",
    },
      {url:'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
    ...
    <main className='w-full sm:mt-24 ' id='about'>
      ...
      <section className='w-full my-12 '>
        <div className='w-full mb-4 sm:mb-16'>
          <h2 className='text-3xl sm:text-4xl'>Why MERAQUI?</h2>
        </div>
        ...
        <div className='w-full sm:flex sm:flex-row sm:ml-16 sm:justify-center'>
          <div className='w-full mt-6 sm:w-[60%] sm:flex sm:flex-col sm:justify-between sm:h-[25vh] sm:my-auto'>
            <div className='w-full'>
              <h3 className='text-[1.4rem] sm:text-[1.6rem] text-left'>The team</h3>
            </div>
      ...
      <section className='w-[95%] mx-auto flex flex-col'>
        <div className='flex flex-col '>
          <div className='w-full mb-4'>
            <h2 className='text-3xl sm:text-4xl'><span className='text-cyan-500'>100k+</span> Happy clients</h2>
          </div>
          <div className='w-full'>
            <p className='text-[1.1rem] sm:text-[1.3rem]'>
        ...
        <div className='flex flex-col my-8 font-normal sm:w-[65%] sm:mx-auto sm:flex-row'>
          <div className='flex flex-row justify-center w-full '>
            ...
            <a className='sm:text-xl' href="mailto:support.meraqui@gmail.com">support.meraqui@gmail.com</a>
          </div>
          <div className='flex flex-row justify-center w-[71%] mt-2 sm:w-[93%]'>
            <FiPhoneCall className='text-2xl mr-2 text-[#1ABDDC] sm:text-4xl'/>
            <a className='sm:text-xl' href="">+91 92564 65813</a>
          </div>
        </div>
      </section>
    </main>
