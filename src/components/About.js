      ...
      <div className='w-full mb-4 sm:mb-16'>
        ...
        <div className=' grid  grid-cols-1 sm:grid-cols-3 sm:w-[95%] sm:ml-32 sm:mx-auto'>
          <div className='sm:flex sm:flex-col w-[100%]  mb-4 sm:mb-0'>
            ...
            <div className='sm:flex w-[100%]  sm:w-[68%] sm:bottom-5  bg-cyan-200 sm:relative sm:mb-8'>
              <div className='flex justify-center w-[88%] mx-auto rounded-[10px] bg-cyan-400 bottom-6 relative shadow-lg h-[8vh] flex-col sm:mx-auto bg-white sm:shadow-sm sm:w-[88%] sm:h-[15vh] sm:flex sm:justify-center sm:flex-col sm:rounded-[10px] sm:relative '>
          ...
          <div className='sm:flex sm:flex-col w-[100%] mb-4 sm:mb-0'>
            ...
            <div className='sm:flex w-[100%]  sm:w-[68%] sm:bottom-5 bg-cyan-200 sm:relative sm:mb-8'>
              <div className='flex justify-center w-[88%] mx-auto rounded-[10px] bg-cyan-400 bottom-6 relative shadow-lg h-[10vh] flex-col sm:mx-auto bg-white sm:shadow-sm sm:w-[88%] sm:h-[15vh] sm:flex sm:justify-center sm:flex-col sm:rounded-[10px] sm:relative '>
