...
const NeemNaps = () => {
  return (
    ...
    <div style={{backgroundImage:"url(https://images.unsplash.com/photo-1531545514256-b1400bc00f31?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80)"}} className='bg-cover bg-center w-full sm:h-[180vh]'>
      <div className='  flex flex-col w-full bg-black bg-opacity-[0.7] text-white sm:h-[55vh] sm:justify-center sm:h-[180vh]'>
