...
const NeemNaps = () => {
  return (
    ...
    <div style={{backgroundImage:"url(https://images.unsplash.com/photo-1531545514256-b1400bc00f31?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80)"}} className='bg-cover bg-center w-full sm:h-[155vh]'>
      <div className='  flex flex-col w-full bg-black bg-opacity-[0.7] text-white sm:h-[55vh] sm:justify-center sm:h-[155vh]'>
        ...
        <div className='w-[95%] sm:w-[89%] mx-auto my-4'>
          ...
          •	To Facilitate registration of Establishment, Basic Training Centre, or mapping of Basic Training Provider
...
•	Processing and Payment of stipends to apprentices 
        ...
        <div className='w-[95%] sm:w-[89%] mx-auto my-4 h-[1000vh]'>
          <p className='text-left sm:w-[85%] font-poppins font-[300]'>
            <br></br>
            <br></br>
