    ...
    <main className='w-full h-fill mt-8 sm:mt-24 sm:w-[75%] sm:mx-auto'>
      <section className='flex flex-col justify-center'>
        <div className='w-full'>
          <h2 className='text-3xl sm:text-5xl '>Featured blogs</h2>
        </div>
        <div className='w-full mt-2'>
          <p className=' text-[1.2rem] sm:text-[1.2rem] '>
      ...
      <section className='flex flex-col w-full mt-6 rounded sm:h-[32vh] shadow-md pb-8'>
        <div className='flex flex-col w-full sm:flex-row sm:justify-center sm:text-left sm:h-[32vh]'>
          ...
          <div className='w-full flex flex-col justify-center sm:w-[80%] sm:h-[30vh]  mt-4 sm:text-left'>
            <h2 className='text-2xl sm:text-3xl'>IBM Power</h2>
            ...
            <div className='w-full sm:text-right sm:w-[94%] sm:mt-8'>
              <a className='text-[0.8rem] border-b-[1px] border-cyan-400 sm:text-[1rem]' href="#main">Read more</a>
            </div>
          </div>
        </div>
      ...
      {/* <section className='flex flex-col w-full mt-6 rounded sm:h-[32vh] shadow-md pb-8'>
        <div className='flex flex-col w-full sm:flex-row sm:justify-center sm:text-left sm:h-[32vh]'>
          <div className='w-full flex justify-center sm:w-[37%] sm:h-[25vh]  sm:inline sm:mr-8 sm:ml-4'>
            <div style={{backgroundImage:"url(https://images.unsplash.com/photo-1664575599730-0814817939de?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)"}} className=' bg-cover bg-center w-[65%] h-[25vh] bg-black sm:h-[30vh] sm:w-[100%]  sm:mt-2 '></div>
          </div>
          <div className='w-full flex flex-col justify-center sm:w-[80%] sm:h-[30vh]  mt-4 sm:text-left'>
            <h2 className='text-2xl sm:text-3xl'>Featured blogs</h2>
            <div className='flex justify-center w-full mt-2'>
              <p className='text-[0.6rem] w-[60%] sm:w-[100%] sm:mr-8 sm:text-[0.9rem] sm:leading-8 '>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis quo veritatis, cum vel facilis ratione, consectetur obcaecati blanditiis minima libero ad sunt! Obcaecati omnis ea officia ducimus provident sint aliquam?
              </p>
            </div>
            <div className='w-full sm:text-right sm:w-[94%] sm:mt-8'>
              <a className='text-[0.8rem] border-b-[1px] border-cyan-400 sm:text-[1rem]' href="#">Read more</a>
            </div>
          </div>
        </div>
         */}
      ...
      <section className='flex flex-col w-full mt-6 rounded sm:h-[32vh] shadow-md pb-8'>
        <div className='flex flex-col w-full sm:flex-row sm:justify-center sm:text-left sm:h-[32vh]'>
          <div className='w-full flex justify-center sm:w-[37%] sm:h-[25vh]  sm:inline sm:mr-8 sm:ml-4'>
            <div style={{backgroundImage:"url(https://images.unsplash.com/photo-1550399105-c4db5fb85c18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80)"}} className=' bg-cover bg-center w-[65%] h-[25vh] bg-black sm:h-[30vh] sm:w-[100%]  sm:mt-2 '></div>
          </div>
          <div className='w-full flex flex-col justify-center sm:w-[80%] sm:h-[30vh]  mt-4 sm:text-left'>
            <h2 className='text-2xl sm:text-3xl'>Featured blogs</h2>
            <div className='flex justify-center w-full mt-2'>
        ...
        <div className='w-full sm:flex sm:flex-row'>
          <div className='w-full sm:w-[75%]'>
            <div className='w-full flex justify-center'>
              <h1 className=' text-2xl w-[90%] sm:text-left sm:text-[2.4rem] sm:leading-[1.3]'>
          ...
          <div className='w-full mt-8 sm:w-[65%]'>
            <div className='w-full flex justify-center sm:w-[90%]'>
              <p className=' sm:text-left sm:font-normal sm:w-[100%] sm:text-[1.2rem]'>
            ...
            <div className='w-full mt-7 sm:flex sm:justify-start'>
              <input
                ...
                id=""
                className=' border-b-[1px] outline-none border-black  sm:w-[95%] sm:text-[1.2rem]'
              />
            </div>
          </div>
        </div>
