...
const Navbar = () => {
  ...
  return (
    <nav className=' max-w-full flex flex-col justify-between mx-1 sm:mx-0 sm:bg-[#FFFFFF]  mt-4 sm:mt-0 sm:py-4  sm:fixed sm:bg-opacity-[0.9] z-50 sm:w-full'>
        <div className="max-w-full flex flex-row justify-between mx-1  mt-1 sm:justify-evenly">
            ...
            <ul className='  w-[75%] hidden  md:flex sm:flex sm:flex-row sm:justify-evenly md:justify-evenly sm:font-normal text-[1.2rem]'>
                ...
                <Link onClick={() => setIsHidden(false)} to='/engine' className="mt-2  hover:text-slate-400 mx-1">M-Engine</Link>
                <Link onClick={() => setIsHidden(false)} to='/contact' className="mt-2  hover:text-slate-400 mx-1">Contact</Link>
                <Link onClick={() => setIsHidden(false)} to='/' className=" mb-1 w-[12%]  justify-center h[12vh] flex  hover:text-slate-400 mx-1"><div className=' border-[1px] border-black w-[30%] mb-2 h-[5vh] flex justify-center rounded-[50%] mt-2'><p className='mt-1'>EN</p></div></Link>
            </ul>
            {isHidden && <ul className=" font-normal sm:hidden  list-none text-lg text-center absolute top-0 bottom-0  flex flex-col bg-cyan-100 h-full w-[60%] m-2 mt-1  rounded-xl  right-0 text-black ">
                ...
                <Link onClick={() => setIsHidden(false)} to='/engine' className="inline p-4 hover:text-slate-400 mx-1">M-Engine</Link>
