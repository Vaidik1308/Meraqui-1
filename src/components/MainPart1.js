...
const MainPart1 = () => {
    ...
    const slides2 = [
        ...
        {
            url:require('../image/whyChooseUs/MEngine1.jpg'),
            header:" 1000 workers required for your new plant? 2",
            body:"We can source and deploy in jiffy through our Pan India Node network on portal",
    ...
    const slides4 = [
        ...
        {
            url:require('../image/img/1.jpg.jpg'),
            header:" 1000 workers required for your new plant? 2",
            body:"We can source and deploy in jiffy through our Pan India Node network on portal",
        ...
        },
        {
            ...
            url:require('../image/img/2.jpg.jpg'),
            header:" 1000 workers required for your new plant? 3",
            body:"We can source and deploy in jiffy through our Pan India Node network on portal",
        ...
        {
            // url:"https://images.unsplash.com/photo-1521401415461-83e7162b8e64?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80",
            url:require('../image/img/3.jpg.jpg'),
            header:" 1000 workers required for your new plant? 4",
            body:"We can source and deploy in jiffy through our Pan India Node network on portal",
                ...
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='w-[95%] text-[1rem] relative top-[-23%] text-left text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides1[0].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative top-[-23%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides1[1].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative top-[-15%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides1[2].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className=' text-left relative top-[-23%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides1[3].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className=' text-left relative top-[-15%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides1[4].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides1[5].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
            </Swiper>
                ...
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-32%] text-black left-[3%] sm:top-[-15%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides2[0].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-32%] text-black left-[3%] sm:top-[-15%] sm:left-[3%] sm:font-bold z-[99] sm:text-3xl'>{slides2[1].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-32%] text-black left-[3%] sm:top-[-15%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides2[2].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides2[3].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides2[4].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides2[5].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
            </Swiper>
                ...
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[85%] top-[-23%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides3[0].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[85%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides3[1].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides3[2].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-14%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides3[3].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-14%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides3[4].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides3[5].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
            </Swiper>
                ...
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides4[0].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-32%] text-black left-[3%] sm:top-[-15%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides4[1].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides4[2].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-25%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides4[3].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-33%] text-black left-[3%] sm:top-[-15%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides4[4].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide className='flex flex-row w-[95%] mx-auto  mt-4'>
                    <section className='flex flex-row w-[95%] mx-auto  mt-4'>
                        <div className='w-[100%] sm:w-[95%] '>
                            ...
                            <p className='text-left relative w-[100%] top-[-15%] text-black left-[3%] sm:top-[-10%] sm:left-[3%] sm:w-[85%] sm:font-bold z-[99] sm:text-3xl'>{slides4[5].sub_header}</p>
                        </div>
                    </section>
                </SwiperSlide>
            </Swiper>
